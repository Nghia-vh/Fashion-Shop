...
<div class="hero">
                ...
                <h1>Danh Sách Sản Phẩm Của  {{$ten_nhasx}}
</h1>
							</div>
						</div>
						<div class="col-lg-7">
...
<div class="d-flex justify-content-center mt-4">
                {{ $list_nhasx->links('pagination::bootstrap-4') }}
            </div> 
